...
<!--文件体开始-->
		...
		<form name="order" method="post" action="OrderSaveServlet">
...
<!--文件尾开始-->
		...
		<tr>
			...
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="user/productDetail?id=1" target="_blank">${p.key}</a></td>
		...
		<tr>
			...
			<td class=tablebody1 valign=middle align=left width="">合计：<font color="#ff0000"><b>￥<%=sc.getCost() %></b></font></td>
		</tr>
		        </table>
