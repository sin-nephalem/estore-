...
<%@page import="com.briup.app.estore.dao.impl.OrderDaoImpl"%>
...
<!--文件体开始-->
        ...
        <c:forEach items="${list}" var="orders" varStatus="o">
		<tr>
			<td class=tablebody2 valign=middle align=center width="">${o.index}</td>
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="">${list.id }</a></td>
			<td class=tablebody2 valign=middle align=left width="">&nbsp;&nbsp;￥${list.cost}</td>
